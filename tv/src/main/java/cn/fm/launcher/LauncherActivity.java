...
public class LauncherActivity extends Activity {
    ...
    private LauncherListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initUI();
        initData();
        adapter = new LauncherListAdapter(this, contentList);
        verticalGridView.setAdapter(adapter);
    }

    private void initUI() {
        verticalGridView = findViewById(R.id.content_list);
        verticalGridView.setNumColumns(contentList.size());
